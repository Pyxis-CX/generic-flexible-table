...
|---|---|---|
| `@pyxis-cx/generic-flexible-table` | Componente, parts componibles, hooks del store | Sí |
| `@pyxis-cx/generic-flexible-table/server` | Adapters de datos, motor puro, helpers REST | No — usable en RSC y Node |
| `@pyxis-cx/generic-flexible-table/export` | CSV/PDF (jspdf es peer **opcional**, carga diferida) | No |
