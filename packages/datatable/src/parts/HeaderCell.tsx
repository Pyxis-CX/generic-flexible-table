...
import type { DragEvent, KeyboardEvent, MouseEvent, PointerEvent as ReactPointerEvent, ReactNode } from 'react'
...
function HeaderCellInner<T>({ item }: HeaderCellProps<T>) {
...
type HeaderCellComponent = <T>(props: HeaderCellProps<T>) => ReactNode
export const HeaderCell: HeaderCellComponent = memo(HeaderCellInner) as HeaderCellComponent
