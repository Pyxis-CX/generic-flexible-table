...
export const StructuralHeaderCell = memo(StructuralHeaderCellInner) as typeof StructuralHeaderCellInner
...
export const FilterCell = memo(FilterCellInner) as typeof FilterCellInner
